...
@Slf4j
@Component
public class WangYiYunApiHandler extends  AbstractKeyWordHandler{
    ...
    protected HttpApiContext preRequest(MessageEventContext messageEventContext) {
        ...
        httpApiContext.setUrl("https://v.api.aa1.cn/api/api-wenan-wangyiyunreping/index.php?aa1=text");
