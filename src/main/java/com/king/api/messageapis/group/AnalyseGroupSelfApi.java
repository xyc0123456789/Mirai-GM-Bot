...
@Slf4j
@Component
public class AnalyseGroupSelfApi extends AbstractGroupMessageApi {
    @Override
    public boolean condition(MessageEventContext messageEventContext) {
        return "#selfanalysegroup".equalsIgnoreCase(messageEventContext.getContent());
    }
    ...
    public CommonResponse handler(MessageEventContext messageEventContext) {
        ...
        MessageAnalysisUtil.analyseGroup(groupId, id, new Date());
        return null;
    }
    ...
    public String commandName() {
        return "message.analyse.group.self";
    }
}
