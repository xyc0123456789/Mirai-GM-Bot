...
import com.king.db.pojo.GroupSpecialListExample.Criteria;
import com.king.db.pojo.GroupSpecialListExample.Criterion;
import com.king.db.pojo.GroupSpecialListExample;
import java.util.List;
import org.apache.ibatis.jdbc.SQL;

public class GroupSpecialListSqlProvider {
    public String insertSelective(GroupSpecialList record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("group_special_list");
    ...
    public String selectByExampleWithBLOBs(GroupSpecialListExample example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(GroupSpecialListExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("group_id");
        } else {
    ...
    public String updateByPrimaryKeySelective(GroupSpecialList record) {
        SQL sql = new SQL();
        sql.UPDATE("group_special_list");
    ...
    protected void applyWhere(SQL sql, GroupSpecialListExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
